...
With every asset its own cluster the directions span the whole space
whenever none vanishes, and with a single cluster there is nothing to
condition on. In both cases $w_\gamma$ is the minimum-variance portfolio for
