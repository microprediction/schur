...
The interior example of \cref{sec:where} is an instance. There
$\beta=0$ and $E=1$, so the member part is $1$, and the variable
$x=(1-\gamma)/(4-\gamma)$ is the knot exposure $\kappa_2(\gamma)$ with
$a_2=c_2=1$ and $\sigma_{p_2}^2=4$.
