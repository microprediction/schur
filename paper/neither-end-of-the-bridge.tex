...
portfolio rather than replicate it. None of the results below rely on
exactness at $\gamma = 1$.
...
symmetrization. The fitness is the \emph{naive portfolio variance}
\begin{equation}
...
vanishes, exactness \cite{mograby2025} notwithstanding; as $\gamma \to 0$,
$G'$ vanishes while the population gain $-V_0'(0)$ does not.
\end{remark}
...
is interactive at \texttt{schur.microprediction.org} (the ``Demo'' page), with the
wider demonstration suite at \texttt{allocation.microprediction.org}.
