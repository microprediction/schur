...
dial. Its optimal setting is interior, it decreases with the noise, and it
solves $\tau^2 = -V_0'/G'$. Exact recovery of minimum variance at full
coupling does not change this, and neither does the noise-robustness of HRP.
