...
\title{{Schur Damping for Perpetual Demand Lending Pools}}
\author{Peter Cotton}
\date{June 18, 2026}
...
\section{The pool-merging decision is the \texorpdfstring{$\gamma$}{gamma}-bridge endpoints}
...
\label{claim:b1}
If $\smax(A) < \smin(\Sig/C)$ and $\smax(C)<\smin(\Sig/A)$ then the single
...
The contribution is a dial. \citet{chitra2025} already reach for the
