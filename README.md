...
construction via block-matrix inversion (Schur complement) and related applications in applied mathematics. 
...
**Online / streaming implementation:** [`allocation`](https://github.com/microprediction/allocation) (Schur via Fiedler seriation; low-turnover streaming over a changing universe) — [docs](https://allocation.microprediction.org)
